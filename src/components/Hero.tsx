...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-slate-50 dark:bg-slate-900 overflow-hidden pt-20 transition-colors duration-300">
      ...
      <div className="absolute top-[20%] left-[-10%] w-[45vw] h-[45vw] rounded-full bg-cyan-700/5 dark:bg-cyan-500/5 blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 py-16">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-6 md:space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#003B46]/10 text-[#003B46] dark:bg-[#07575B]/30 dark:text-[#a8e6cf] text-xs font-mono font-medium max-w-fit align-middle">
            <ShieldCheck className="w-4 h-4 text-[#07575B] dark:text-[#41B3A3]" />
          ...
          <h1 className="text-4xl md:text-6xl font-sans font-black text-slate-950 dark:text-white tracking-tight leading-tighter">
            Pareceres Técnicos, <span className="bg-gradient-to-r from-[#003B46] to-[#07575B] dark:from-[#2E8B9A] dark:to-[#41B3A3] bg-clip-text text-transparent">Laudos e ART</span> com Rigor e Segurança.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a
              href="#contato"
              className="px-8 py-4 rounded-xl bg-[#003B46] hover:bg-[#07575B] text-white font-semibold transition-all shadow-lg hover:shadow-cyan-900/15 text-center flex items-center justify-center gap-2 group"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-slate-200/60 dark:border-slate-800 max-w-lg">
            <div>
              <span className="block text-2xl md:text-3xl font-bold text-[#003B46] dark:text-[#41B3A3] font-mono">100%</span>
            ...
            <div>
              <span className="block text-2xl md:text-3xl font-bold text-[#003B46] dark:text-[#41B3A3] font-mono">PE</span>
            ...
            <div className="col-span-2 md:col-span-1">
              <span className="block text-2xl md:text-3xl font-bold text-[#003B46] dark:text-[#41B3A3] font-mono">ART</span>
        ...
        <div className="lg:col-span-5 flex flex-col justify-center">
          <div className="relative group w-full max-w-sm mx-auto lg:max-w-none">
            ...
            <div className="absolute -inset-1.5 bg-gradient-to-r from-[#003B46] via-[#07575B] to-[#41B3A3] rounded-3xl blur opacity-25 group-hover:opacity-40 transition duration-1000 pointer-events-none" />
            ...
            <div className="relative bg-white dark:bg-slate-950 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xl overflow-hidden p-3.5 transition-colors duration-300">
              ...
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 shadow-inner group-hover:border-[#07575B]/30 dark:group-hover:border-[#41B3A3]/30 transition-colors duration-500">
                <img 
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950 via-slate-950/55 to-transparent p-6 pt-24 flex flex-col justify-end text-left pointer-events-none">
                  <span className="text-[10px] font-mono font-bold tracking-widest text-[#41B3A3] uppercase block mb-1">
                  ...
                  <p className="text-xs text-[#a8e6cf] font-mono font-semibold">
                    CREA-PE 1822299490
                  </p>
                </div>

                {/* Availability indicator badge */}
                <div className="absolute top-4 right-4 inline-flex items-center gap-1.5 px-3 py-1 bg-[#003B46]/95 backdrop-blur-md text-white rounded-full text-[10px] font-mono font-bold uppercase tracking-wider border border-white/10 shadow-lg select-none">
              ...
              <div className="p-4 space-y-4 text-left">
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px] border-t border-slate-100 dark:border-slate-800/80 pt-3.5 pb-1 font-mono">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="font-semibold text-[#07575B] dark:text-[#41B3A3]">24h Exclusivo</span>
                  </div>
                </div>
                ...
                <a
                  href="#login"
                  className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-slate-50 dark:bg-slate-900 hover:bg-[#003B46] hover:text-white dark:hover:bg-[#07575B] dark:hover:text-white border border-slate-200 dark:border-slate-800 text-[#003B46] dark:text-slate-350 text-xs font-bold transition-all uppercase tracking-widest font-mono cursor-pointer text-center"
                >
